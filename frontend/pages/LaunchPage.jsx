    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-20">
      <div className="w-full max-w-lg text-center">
        ...
        <div className="navbar-buttons mt-8 flex items-center justify-center gap-3">
          <button type="button" onClick={() => navigate('/signin')} id="sign-in" className="px-6 py-2.5 rounded-md bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 active:bg-blue-800 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            Sign In
          </button>
          ...
          <ul className="mt-5 grid grid-cols-2 gap-x-8 gap-y-4 max-w-sm mx-auto text-left">
            {partners.map((partner) => (
              <li key={partner.name} className="flex items-center gap-2 text-sm text-gray-700">
                <a href={partner.website} target="_blank" className="flex items-center gap-2">
